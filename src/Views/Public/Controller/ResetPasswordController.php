...
use App\Domain\Form\ChangePasswordFormType;
use App\Domain\Form\ResetPasswordRequestFormType;
...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        ...
        if (null === $token) {
            ...
            throw $this->createNotFoundException('Не найден токен сброса пароля в URL или сессии');
        }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('info@luchmarket.ru', 'Aboard'))
            ->to($user->getEmail())
